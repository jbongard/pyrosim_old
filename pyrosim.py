...
class PYROSIM:
	...
	def __init__(self,playBlind=False,playPaused=False):
		...
		self.simulator = Popen(commandsToSend, stdout=PIPE, stdin=PIPE, stderr=PIPE)
                ...
                self.Send('EvaluationTime {}\n'.format(constants.evaluationTime))
